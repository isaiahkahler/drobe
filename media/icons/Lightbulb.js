...
export default function Lightbulb(props) {
  return (
    <Svg height="54.354" style={{"isolation":"isolate"}} width="37.346" viewBox="139.349 105.808 37.346 54.354">
    	<G>
    		...
    		<Path d=" M 156.506 146.841 L 156.506 131.209 C 156.417 129.883 155.729 129.05 154.431 128.699 C 153.011 128.243 151.243 129.59 151.243 131.209 C 151.243 132.416 152.254 133.505 153.769 133.726 L 161.681 133.87 C 163.55 134.093 164.593 133.27 164.801 131.392 C 164.769 129.632 164.028 128.657 162.568 128.455 C 160.574 128.496 159.597 129.417 159.628 131.209 L 159.628 146.841" fill="none" stroke="rgb(140,100,255)" strokeLinecap="square" strokeWidth="1" vectorEffect="non-scaling-stroke"/>
    	</G>
    </Svg>
  );
}
