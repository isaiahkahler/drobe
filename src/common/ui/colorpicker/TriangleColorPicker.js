...
import {FullButton, PC} from '../basicComponents';
    ...
    return (
      <View style={style}>
        ...
        <View style={[styles.colorPreviews, computed.colorPreviews]}>
          ...
          //   activeOpacity={0.7}
          // >
          //   {/* <Text style={[commonStyles.pb, { color: (Color((this.props.oldColor)).luminosity() <= 0.5) ? "#fff" : "#000"}]}>revert color</Text> */}
          // </TouchableOpacity>
          <FullButton
            style={{ backgroundColor: oldColor }}
            onPress={this._onOldColorSelected}
          >
            {/* <P style={{ color: (Color((this.props.oldColor)).luminosity() <= 0.5) ? "#fff" : "#000"}}>revert color</P> */}
            <PC style={{ color: tinycolor(this.props.oldColor).isLight() ? "#000" : "#fff"}}>revert color</PC>
          </FullButton>
          }
          {/* <TouchableOpacity
          ...
          <FullButton
            ...
            onPress={this._onColorSelected}
          >
            {/* <P style={{ color: (Color(fromHsv(this.state.color)).luminosity() <= 0.5) ? "#fff" : "#000"}}>select</P> */}
            <PC style={{ color: tinycolor(this.state.color).isLight() ? "#000" : "#fff"}}>select</PC>
          </FullButton>
        </View>
      </View>
    )
